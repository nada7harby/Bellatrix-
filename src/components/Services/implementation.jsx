            ...
            <div className="bg-white py-12">
                <div className="container mx-auto px-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-8">
                        ...
                        <div className="flex-1">
                            <div className="bg-gradient-to-br from-white via-blue-50/30 to-blue-100/30 rounded-3xl p-8 border border-blue-100 shadow-2xl hover:shadow-blue-100 hover:shadow-2xl transition-all duration-500 relative overflow-hidden group">
                                {/* Creative Background Elements */}
                                <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full opacity-10 transform translate-x-16 -translate-y-16 group-hover:opacity-20 transition-opacity duration-500"></div>
                                <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-blue-300 to-blue-500 rounded-full opacity-10 transform -translate-x-10 translate-y-10 group-hover:opacity-20 transition-opacity duration-500"></div>
                                <div className="absolute top-1/2 left-1/2 w-16 h-16 bg-gradient-to-r from-blue-200 to-blue-400 rounded-full opacity-5 transform -translate-x-8 -translate-y-8 group-hover:opacity-15 transition-opacity duration-500"></div>
                                
                                <div className="relative z-10 space-y-4">
                                    {/* Feature 1 */}
                                    <div className="group/item hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent rounded-xl p-3 transition-all duration-300 hover:transform hover:translate-x-2">
                                        <div className="flex items-center">
                                            <div className="relative mr-3">
                                                <div className="w-7 h-7 bg-gradient-to-br from-blue-400 to-blue-500 rounded-lg flex items-center justify-center shadow-lg group-hover/item:scale-110 transition-all duration-300">
                                                    <span className="text-white font-bold text-xs">01</span>
                                                </div>
                                                <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-600 rounded-lg blur opacity-30 group-hover/item:opacity-60 transition-opacity duration-300"></div>
                                            </div>
                                            <div className="flex-1">
                                                <h3 className="text-lg font-bold bg-gradient-to-r from-gray-800 to-blue-500 bg-clip-text text-transparent mb-1 group-hover/item:from-blue-500 group-hover/item:to-blue-600 transition-all duration-300">Proven Expertise</h3>
                                                <p className="text-sm text-gray-600">500+ successful implementations across industries</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group/item hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent rounded-xl p-3 transition-all duration-300 hover:transform hover:translate-x-2">
                                        <div className="flex items-center">
                                            <div className="relative mr-3">
                                                <div className="w-7 h-7 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg group-hover/item:scale-110 transition-all duration-300">
                                                    <span className="text-white font-bold text-xs">02</span>
                                                </div>
                                                <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg blur opacity-30 group-hover/item:opacity-60 transition-opacity duration-300"></div>
                                            </div>
                                            <div className="flex-1">
                                                <h3 className="text-lg font-bold bg-gradient-to-r from-gray-800 to-blue-600 bg-clip-text text-transparent mb-1 group-hover/item:from-blue-600 group-hover/item:to-blue-700 transition-all duration-300">Rapid Deployment</h3>
                                                <p className="text-sm text-gray-600">50% faster implementation with proven tools</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group/item hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent rounded-xl p-3 transition-all duration-300 hover:transform hover:translate-x-2">
                                        <div className="flex items-center">
                                            <div className="relative mr-3">
                                                <div className="w-7 h-7 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-lg group-hover/item:scale-110 transition-all duration-300">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-lg font-bold bg-gradient-to-r from-gray-800 to-blue-700 bg-clip-text text-transparent mb-1 group-hover/item:from-blue-700 group-hover/item:to-blue-800 transition-all duration-300">24/7 Support</h3>
                                                <p className="text-sm text-gray-600">Round-the-clock technical support & monitoring</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="group/item hover:bg-gradient-to-r hover:from-blue-50 hover:to-transparent rounded-xl p-3 transition-all duration-300 hover:transform hover:translate-x-2">
                                        <div className="flex items-center">
                                            <div className="relative mr-3">
                                                <div className="w-7 h-7 bg-gradient-to-br from-blue-700 to-blue-800 rounded-lg flex items-center justify-center shadow-lg group-hover/item:scale-110 transition-all duration-300">
                                            ...
                                            <div className="flex-1">
                                                <h3 className="text-lg font-bold bg-gradient-to-r from-gray-800 to-blue-800 bg-clip-text text-transparent mb-1 group-hover/item:from-blue-800 group-hover/item:to-blue-900 transition-all duration-300">Expert Team</h3>
                                                <p className="text-sm text-gray-600">Certified professionals with deep expertise</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
